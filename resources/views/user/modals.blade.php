...
<div class="btn-group">
	...
	<div class="dropdown-menu">
	  ...
	  <div class="dropdown-divider"></div>
	  <a class="dropdown-item" target="_blank" href="https://easycrypto.ai/">Easy Crypto</a>
	  <div class="dropdown-divider"></div>
	  <a class="dropdown-item" target="_blank" href="https://www.binance.com/en">Binance</a>
	  <div class="dropdown-divider"></div>
	  <a class="dropdown-item" target="_blank" href="https://www.coinbase.com/">Coin Base</a>
	  <div class="dropdown-divider"></div>
		...
		<div class="dropdown-divider"></div>
		<a class="dropdown-item" target="_blank" href="https://safello.com/">Safello</a>
		<div class="dropdown-divider"></div>
		<a class="dropdown-item" target="_blank" href="https://paybis.com/">Paybis</a>
		<div class="dropdown-divider"></div>
		<a class="dropdown-item" target="_blank" href="https://www.coinmama.com/">Coinmama</a>
		<div class="dropdown-divider"></div>
		<a class="dropdown-item" target="_blank" href="https://paxful.com/">Paxful</a>
		<div class="dropdown-divider"></div>
		<a class="dropdown-item" target="_blank" href="https://localbitcoins.com/">Local Bitcoin</a>
		<div class="dropdown-divider"></div>
		  <a class="dropdown-item" target="_blank" href="https://banxa.com/">Banxa</a>
		  <div class="dropdown-divider"></div>
		  <a class="dropdown-item" target="_blank" href="https://bit2me.com/">Bit2me</a>
		  <div class="dropdown-divider"></div>
		  <a class="dropdown-item" target="_blank" href="https://nordikcoin.com/">Nordikoin </a>
		  <div class="dropdown-divider"></div>
		  <a class="dropdown-item" target="_blank" href="https://bitonic.nl/en/">Bitonic</a>
		  <div class="dropdown-divider"></div>
		  <a class="dropdown-item" target="_blank" href="https://www.cointree.com/">Cointree </a>
		  <div class="dropdown-divider"></div>
	  </div>
  </div>
  <br>
