...
<head>
    ...
    <link href="{{asset ('assets/lib/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
    ...
    <link href="{{asset('assets/css/frontend_style_blue.css')}}" rel="stylesheet">
      ...
      <div class="container">
        ...
        <div class="text-center row about-cols">
          ...
          <div class="col-lg-3 col-md-4 wow fadeInUp">
            <div class="about-col">
              <div class="img">
                <img src="{{ asset ('assets/img/about/innovate.png')}}" alt="" class="mt-4 w-25">
          ...
          <div class="col-lg-3 col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              <div class="img">
                <img src="{{ asset ('assets/img/about/secure.png')}}" alt="" class="mt-4 w-25">
          ...
          <div class="col-lg-3 col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="{{ asset ('assets/img/about/prof.png')}}" alt="" class="mt-4 w-25">
          ...
          <div class="col-lg-3 col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="{{ asset ('assets/img/about/invest.png')}}" alt="" class="mt-4 w-25">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon" >
                <svg class="svg">
                  <use xlink:href="{{ asset ('assets/img/sprite.svg#icon-stable')}}"></use>
                </svg>
              </div>
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon">
                <svg class="svg">
                  <use xlink:href="{{ asset ('assets/img/sprite.svg#icon-payment')}}"></use>
                </svg>
              </div>
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon">
                <svg class="svg">
                  <use xlink:href="{{ asset ('assets/img/sprite.svg#icon-referral')}}"></use>
                </svg>
              </div>
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon">
                <svg class="svg">
                  <use xlink:href="{{ asset ('assets/img/sprite.svg#icon-dollar')}}"></use>
                </svg>
              </div>
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.2s" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon">
                <svg class="svg">
                  <use xlink:href="{{ asset ('assets/img/sprite.svg#icon-support')}}"></use>
                </svg>
              </div>
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.2s" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon">
                <svg class="svg">
                  <use xlink:href="{{ asset ('assets/img/sprite.svg#icon-shield')}}"></use>
                </svg>
              </div>
    ...
    <section id="payments" class="wow fadeInUp">
      <div class="container">
        ...
        <div class="owl-carousel payments-carousel">
          <img src="{{ asset('assets/img/payments/payment-1.png')}}" alt="">
          <img src="{{ asset('assets/img/payments/payment-2.png')}}" alt="">
          <img src="{{ asset('assets/img/payments/payment-3.png')}}" alt="">
          <img src="{{ asset('assets/img/payments/payment-4.png')}}" alt="">
          <img src="{{ asset('assets/img/payments/payment-5.png')}}" alt="">
          <img src="{{ asset('assets/img/payments/payment-6.png')}}" alt="">
          <img src="{{ asset('assets/img/payments/payment-7.png')}}" alt="">
          <img src="{{ asset('assets/img/payments/payment-8.png')}}" alt="">
        </div>
