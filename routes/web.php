...
Route::group(['prefix' => 'admin',  'middleware' => 'isadmin'], function()
{
	...
	Route::get('dashboard/add-wallet/{id}', 'App\Http\Controllers\Admin\HomeController@addwallet')->name('add.wallet');
	Route::post('dashboard/updateacct', 'App\Http\Controllers\Admin\HomeController@updateacct')->name('updateacount');
